...
set Libs= SDL2.lib SDL2main.lib glew32.lib opengl32.lib freetype.lib shell32.lib EASTL.lib Advapi32.lib
...
cl %CompilerFlags% %Defines% /DSTB_IMAGE_IMPLEMENTATION /DPACKAGER_STANDALONE  /Fe:"packager" ..\src\general.cpp ..\src\packager\packager.cpp /link %LinkerFlags% /subsystem:console SDL2.lib SDL2main.lib shell32.lib EASTL.lib Advapi32.lib
